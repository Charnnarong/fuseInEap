...
public class NettyhttpButton extends Button {

	public NettyhttpButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testnettyhttp(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						NettyhttpButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						NettyhttpButton.this.getElement().getStyle().setProperty("background", "pink");
