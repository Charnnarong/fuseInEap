...
public class JdbcButton extends Button {

	public JdbcButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testjdbc(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						JdbcButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						JdbcButton.this.getElement().getStyle().setProperty("background", "pink");
