...
public class JettyButton extends Button {

	public JettyButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testjetty(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						JettyButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						JettyButton.this.getElement().getStyle().setProperty("background", "pink");
