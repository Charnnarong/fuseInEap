...
public class SqlTestButton extends Button {

	public SqlTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testsql(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						SqlTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						SqlTestButton.this.getElement().getStyle().setProperty("background", "pink");
