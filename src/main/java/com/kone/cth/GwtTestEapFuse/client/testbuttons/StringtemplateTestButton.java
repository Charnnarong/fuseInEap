...
public class StringtemplateTestButton extends Button {

	public StringtemplateTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.teststringtemplate(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						StringtemplateTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						StringtemplateTestButton.this.getElement().getStyle().setProperty("background", "pink");
