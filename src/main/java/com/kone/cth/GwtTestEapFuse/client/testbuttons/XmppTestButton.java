...
public class XmppTestButton extends Button {

	public XmppTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testxmpp(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						XmppTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						XmppTestButton.this.getElement().getStyle().setProperty("background", "pink");
