...
public class QuartzTestButton extends Button {

	public QuartzTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testquartz(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						QuartzTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						QuartzTestButton.this.getElement().getStyle().setProperty("background", "pink");
