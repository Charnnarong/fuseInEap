...
public class Jt400Button extends Button {

	public Jt400Button(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testjt400(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						Jt400Button.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						Jt400Button.this.getElement().getStyle().setProperty("background", "pink");
