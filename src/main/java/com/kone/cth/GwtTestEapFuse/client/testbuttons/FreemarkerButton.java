...
public class FreemarkerButton extends Button {

	public FreemarkerButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testfreemarker(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						FreemarkerButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						FreemarkerButton.this.getElement().getStyle().setProperty("background", "pink");
