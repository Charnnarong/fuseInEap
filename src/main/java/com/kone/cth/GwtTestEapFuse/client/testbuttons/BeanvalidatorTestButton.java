...
public class BeanvalidatorTestButton extends Button {

	public BeanvalidatorTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testbeanvalidator(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						BeanvalidatorTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						BeanvalidatorTestButton.this.getElement().getStyle().setProperty("background", "pink");
