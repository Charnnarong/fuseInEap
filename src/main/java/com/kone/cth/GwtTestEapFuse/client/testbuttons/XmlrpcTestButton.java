...
public class XmlrpcTestButton extends Button {

	public XmlrpcTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testxmlrpc(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						XmlrpcTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						XmlrpcTestButton.this.getElement().getStyle().setProperty("background", "pink");
