...
public class EjbButton extends Button {

	public EjbButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testejb(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						EjbButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						EjbButton.this.getElement().getStyle().setProperty("background", "pink");
