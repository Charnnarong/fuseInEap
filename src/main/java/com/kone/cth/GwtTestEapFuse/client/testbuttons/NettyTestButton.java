...
public class NettyTestButton extends Button {

	public NettyTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testnetty(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						NettyTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						NettyTestButton.this.getElement().getStyle().setProperty("background", "pink");
