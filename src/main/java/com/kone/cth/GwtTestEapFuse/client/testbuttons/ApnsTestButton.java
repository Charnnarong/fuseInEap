...
public class ApnsTestButton extends Button {

	public ApnsTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testapns(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						ApnsTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						ApnsTestButton.this.getElement().getStyle().setProperty("background", "pink");
