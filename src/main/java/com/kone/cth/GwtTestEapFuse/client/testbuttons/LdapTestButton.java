...
public class LdapTestButton extends Button {

	public LdapTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testldap(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						LdapTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						LdapTestButton.this.getElement().getStyle().setProperty("background", "pink");
