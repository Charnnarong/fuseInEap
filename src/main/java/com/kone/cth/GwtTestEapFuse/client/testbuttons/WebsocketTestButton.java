...
public class WebsocketTestButton extends Button {

	public WebsocketTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testwebsocket(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						WebsocketTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						WebsocketTestButton.this.getElement().getStyle().setProperty("background", "pink");
