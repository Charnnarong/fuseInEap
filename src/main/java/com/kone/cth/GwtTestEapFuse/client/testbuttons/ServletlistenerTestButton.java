...
public class ServletlistenerTestButton extends Button {

	public ServletlistenerTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testservletlistener(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						ServletlistenerTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						ServletlistenerTestButton.this.getElement().getStyle().setProperty("background", "pink");
