...
public class JpaTestButton extends Button {

	public JpaTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testjpa(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						JpaTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						JpaTestButton.this.getElement().getStyle().setProperty("background", "pink");
