...
public class MongoDbButton extends Button {

	public MongoDbButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testmongodb(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						MongoDbButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						MongoDbButton.this.getElement().getStyle().setProperty("background", "pink");
