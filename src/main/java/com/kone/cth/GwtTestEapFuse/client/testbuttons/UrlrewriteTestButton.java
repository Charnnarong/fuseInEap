...
public class UrlrewriteTestButton extends Button {

	public UrlrewriteTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testurlrewrite(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						UrlrewriteTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						UrlrewriteTestButton.this.getElement().getStyle().setProperty("background", "pink");
