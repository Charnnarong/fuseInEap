...
public class SshTestButton extends Button {

	public SshTestButton(String btnName, final FlowPanel textAreaRight,
			...
			public void onClick(ClickEvent event) {
				greetingService.testssh(new AsyncCallback<String>() {
					...
					public void onSuccess(String result) {
						...
						SshTestButton.this.getElement().getStyle().setProperty("background", "lightgreen");
					...
					public void onFailure(Throwable caught) {
						...
						textAreaRight.add(lbl);
						SshTestButton.this.getElement().getStyle().setProperty("background", "pink");
